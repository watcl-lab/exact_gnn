...
def generatee_graphs(num_graphs, D):
    """
    Generates a specified number of graphs.
    ...
    for i in range(num_graphs):
        ...
        all_graphs_adj.append( graph_adj_matrix)

    return all_graphs_adj
...
if __name__ == "__main__":
    ...
    # --- Execution ---
    adj_list = generate_and_save_graphs(
